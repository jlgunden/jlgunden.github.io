...
// /**
//  * Object for page initialization
//  *
//  * @constructor
//  * @param  {string} page The page name, e.g. 'projects', 'index'
//  * @return {void}
//  */
// var init = function(page) {
//   this.page_ = page;

//   // main init common to all
//   var navigation_drawer = new nav_drawer($('#menu'));
//   navigation_drawer.decorate();
...
//   console.log(this);
//   console.log(this[this.page_]);
//   // call page's init method
//   if (typeof(this[this.page_]) === 'function') {
//     this[this.page_]();
//   }
...
// /**
//  * Init method for the contact page
//  *
//  * @return {void}
//  */
// init.prototype.contact = function() {
//   var inputs = {
//     'email_address': {
//       'input_element': $('#email_address'),
//       'error_message_element': $('#email_address_error'),
...
// init.prototype.projects = function() {}
